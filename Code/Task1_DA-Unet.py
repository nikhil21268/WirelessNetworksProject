...
class RadioMapDataset(Dataset):
    def __init__(self, input_dir, output_dir, buildings, transform=None):
...
plt.savefig('loss_curve_DA.png')
plt.show()  


# Save the model
torch.save(model.state_dict(), 'unet_model_da.pth')

# # Load the model for inference
# model = UNet().cuda()
model.load_state_dict(torch.load('unet_model_da.pth'))
model.eval()
