...
plt.savefig('loss_curve_br_da.png')
plt.show()  


# Save the model
torch.save(model.state_dict(), 'unet_model_br_da.pth')

# # Load the model for inference
# model = UNet().cuda()
model.load_state_dict(torch.load('unet_model_br_da.pth'))
model.eval()
