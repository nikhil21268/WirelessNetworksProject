...
input_dir = 'ICASSP2025_Dataset/Inputs/Task_1_ICASSP_Augmented_Inputs'
output_dir = 'ICASSP2025_Dataset/Outputs/Task_1_ICASSP_Augmented_Outputs'
...
model_save_path = "Task1_unet_aspp_final_model.pth"
loss_plot_save_path = "Task1_training_loss_plot.png"
...
test_dir = "Tasks_Eval_Final/ICASSP_Test_Data/Inputs/Task_1"
...
def save_predictions(dataloader, model, output_dir):
    ...
    with torch.no_grad():
        ...
        print(f"Final Prediction Time for Task1 Eval Data : {total_pred_time:.6f}s")        


output_folder = "Task1_Output_Folder"
